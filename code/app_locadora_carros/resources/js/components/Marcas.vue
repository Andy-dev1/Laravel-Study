<template>
    <div class="container">
       ...
       <!-- #region inicio modal de atualizacao de marca -->
        <modal-component id="modalMarcaAtualizar" titulo="Atualizar marca">
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component titulo="Imagem da marca" id="atualizarImagem" id-help="atualizarImagemHelp" texto-ajuda="Selecione uma imagem no formato PNG">
       ...
       <!-- #endregion inicio modal de atualizacao de marca -->
    </div>
</template>
